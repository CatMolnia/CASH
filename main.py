...
class Cash(QWidget):
    ...
    def _init_components(self):
        ...
        self.ui_manager = StartWindow(config, general_information, secondary_information, widget_days_zp, widget_days_avans, widget_days_zp_avans) # применяем стили к окну
